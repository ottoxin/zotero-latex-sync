...
Examples:
  ZOTERO_LIBRARY_ID=123456 ./sync_zotero_bib.sh
  ZOTERO_LIBRARY_TYPE=group ZOTERO_LIBRARY_ID=98765 \
    ZOTERO_COLLECTION_KEY=ABCD1234 ./sync_zotero_bib.sh refs.bib
EOF
}
